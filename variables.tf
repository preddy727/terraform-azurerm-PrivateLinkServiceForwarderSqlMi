...
variable "proxy_subnet_name" {
  description = "The subnet of the proxy scaleset"
  default     = "ForwarderVmssSubnet"
}

variable "pls_subnet_name" {
  description = "The subnet of the Private Link Service"
  default     = "ForwarderPrivateLinkServiceSubnet"
}
